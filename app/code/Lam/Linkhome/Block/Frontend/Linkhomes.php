<?php
namespace Lam\Linkhome\Block\Frontend;

class Linkhomes extends \Magento\Framework\View\Element\Template
{

    const TYPE_SUB_LINK = 'link_sub_home';
    ...
    /**
     * Linkhomes constructor.
     * @param \Magento\Framework\View\Element\Template\Context $context
     * @param \Lam\Linkhome\Model\ItemsFactory $imageCollectionFactory
     * @param array $data
     */
    public function __construct(
        \Magento\Framework\View\Element\Template\Context $context,
        \Lam\Linkhome\Model\ItemsFactory $imageCollectionFactory,
        array $data = [] )
    {
