 ...
 */
namespace Lof\HidePrice\Model\Rule\Condition;
...
class Combine extends \Magento\Rule\Model\Condition\Combine
{
    ...
    public function __construct(
        ...
        \Lof\HidePrice\Model\Rule\Condition\Address $conditionAddress,
        array $data = []
    ) {
        $this->_eventManager = $eventManager;
        $this->_conditionAddress = $conditionAddress;
        parent::__construct($context, $data);
        $this->setType('Lof\HidePrice\Model\Rule\Condition\Combine');
    }
    ...
    public function _getCartConditions()
    {
        ...
        foreach ($addressAttributes as $code => $label) {
            $attributes[] = [
                'value' => 'Lof\HidePrice\Model\Rule\Condition\Address|' . $code,
                'label' => $label,
            ];
        }
