...
class Messages extends Extended
{
    ...
    protected function _prepareCollection()
    {
        ...
        foreach ($collection as $key => $_collection) {
            if($_collection->getData('reply') == 1) {
                $_collection->setData('reply','Yes');
            }else{
                $_collection->setData('reply','No');
            }
        }
    ...
    protected function _prepareColumns()
    {
        ...
        $this->addColumn(
            ...
            [
                'header'   => __('Action'),
                'type'     => 'action',
                'renderer' => 'Lof\HidePrice\Block\Adminhtml\Message\Renderer\MessageAction'
            ]
            );
