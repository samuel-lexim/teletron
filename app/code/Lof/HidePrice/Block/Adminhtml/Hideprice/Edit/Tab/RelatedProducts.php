...
class RelatedProducts extends Extended
{
    ...
    {
        return $this->getHideprice() && $this->getHideprice()->getRelatedReadonly();
    }
    ...
    protected function _prepareColumns()
    {
        ...
        $this->addColumn(
            ...
            'index' => 'position',
            'editable' => !$this->getHideprice()->getRelatedReadonly(),
            'edit_only' => !$this->getHideprice()->getId(),
    ...
    public function getGridUrl()
    {
        return $this->getData(
            ...
            'lofhideprice/*/relatedProductsGrid',
            ['_current' => true]
            );
        }
    ...
    public function getSelectedRelatedProducts()
    {
        ...
        $products = [];
        if(!empty($hideprice->getRelatedProducts())){
            foreach ($hideprice->getRelatedProducts() as $product) {
    ...
    public function filterProductPosition($collection, $column)
    {
        ...
        $hideprice = $this->getHideprice();
        $condition['hideprice_id'] = $hideprice->getHidepriceId();
