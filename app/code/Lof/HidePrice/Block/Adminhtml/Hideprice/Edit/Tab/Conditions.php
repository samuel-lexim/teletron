...
{ 
    ...
    /**
     * @var \Lof\Followuphideprice\Model\Event\Config
     */
    protected $eventConfig; 

    protected $hidepriceModel; 
     ...
     * @param \Magento\Hideprice\Model\Template\Config                          $hidepriceConfig                 
     */
    ...
    protected function _prepareForm()
    {
        ...
        if ($this->_isAllowedAction('Lof_HidePrice::hideprice_edit')) {
        ...
        $form->setHtmlIdPrefix('hideprice_'); 
    ...
    protected function addProductConditions(\Magento\Framework\Data\Form $form, \Lof\HidePrice\Model\Hideprice $model, $fieldsetId = 'actions_fieldset', $formName = 'edit_form') {  
        // hideprice_product_conditions_fieldset
        ...
        'sales_rule/promo_quote/newActionHtml/form/hideprice_actions_fieldset',
        ...
        $fieldset = $form->addFieldset(
            ...
            [
            'legend' => __(
                'Conditions (don\'t add conditions if don\'t rule is applied to all products)'
                )
            ]
            )->setRenderer(
            $renderer
