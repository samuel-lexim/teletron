...
class Messages extends \Magento\Catalog\Controller\Adminhtml\Product
{
    /**
    ...
    public function execute()
    {
        ...
        //$resultLayout->getLayout()->getBlock('hideprice.form.edit.tab.messages')->setProductsCrossSell($this->getRequest()->getPost('relatedmessages', null));
