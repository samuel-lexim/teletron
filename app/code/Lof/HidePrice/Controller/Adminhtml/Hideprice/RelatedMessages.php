...
class RelatedMessages extends \Magento\Catalog\Controller\Adminhtml\Product
{
    /**
    ...
    public function execute()
    {
        ...
        //$resultLayout->getLayout()->getBlock('lofhideprice.hideprice.edit.tab.messages')->setProductsCrossSell($this->getRequest()->getPost('formbuilderrelatedmessages', null));
