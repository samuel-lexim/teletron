...
class RelatedMessagesGrid extends \Magento\Catalog\Controller\Adminhtml\Product
{
    /**
    ...
    public function execute()
    {
        ...
        $resultLayout->getLayout()->getBlock('lofhideprice.hideprice.edit.tab.relatedmessages')
