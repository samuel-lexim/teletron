...
class Save extends \Lof\HidePrice\Controller\Adminhtml\Message
{
    /**
     * Save action
     *
    ...
    public function execute()
    {
        ...
        if ($data) {
            ...
            $model = $this->_objectManager->create('Lof\HidePrice\Model\Message')->load($id);
            if (!$model->getId() && $id) {
            ...
            try {
                ...
                $this->messageManager->addSuccess(__('You saved the message.'));
